...
pub fn run_with_launch(initial_launch: Option<launch::LaunchIntent>) {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::app_settings::set_external_editor_path,
            ...
            commands::branches::local_branch_prune_plan,
            commands::branches::prune_local_branches,
            ...
            commands::rebase::save_conflict_result,
            commands::rebase::mark_conflict_resolved,
