...
#[tauri::command]
pub async fn get_git_identity(repo_path: String) -> Result<GitIdentity, AppError> {
...
#[tauri::command]
pub async fn get_git_credential_config(repo_path: String) -> Result<GitCredentialConfig, AppError> {
    tauri::async_runtime::spawn_blocking(move || {
...
#[tauri::command]
pub async fn set_git_credential_helper(
    repo_path: String,
...
#[tauri::command]
pub async fn test_git_authentication(
    repo_path: String,
...
#[tauri::command]
pub async fn clear_credential_cache(repo_path: String, host: Option<String>) -> Result<String, AppError> {
    tauri::async_runtime::spawn_blocking(move || {
        let repo_path = Path::new(&repo_path);
...
#[tauri::command]
pub async fn run_custom_git_command(
    repo_path: String,
    args: Vec<String>,
