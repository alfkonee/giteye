...
Report abusive, harassing, or otherwise unacceptable behavior privately to the project maintainer using the contact method listed on [the maintainer's GitHub profile](https://github.com/alfkonee). Do not file a public issue containing sensitive personal information.
...
**Consequence:** A warning with consequences for continued behavior and a specified period with no interaction with affected people or those enforcing the policy.
...
**Community impact:** A pattern of violations, harassment, aggression, or disparagement of classes of individuals.
