...
function EmptyRebaseState({ activeRepoPath, loading, error }: { activeRepoPath: string | null; loading: boolean; error: unknown }) {
  ...
  return (
    <section className="flex h-full min-h-0 flex-col bg-[var(--color-bg-primary)] text-[var(--color-text-primary)]">
      ...
      <div className="grid min-h-0 flex-1 grid-cols-1 gap-3 overflow-auto p-3 xl:grid-cols-[minmax(700px,1fr)_300px] xl:overflow-hidden">
...
export function RebaseConflictResolver() {
  ...
  return (
    <section className="flex h-full min-h-0 flex-col bg-[var(--color-bg-primary)] text-[var(--color-text-primary)]">
      ...
      <div className="grid min-h-0 flex-1 grid-cols-1 gap-3 overflow-auto p-3 xl:grid-cols-[350px_minmax(700px,1fr)_300px] xl:overflow-hidden">
